...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //-----------------------------------------------------------
        // 1) Demo: inyección SQL sobre el método INSEGURO
        //-----------------------------------------------------------
        ...
        //-----------------------------------------------------------
        // 2) Demo: el mismo ataque sobre el método SEGURO
        //-----------------------------------------------------------
        System.out.println("=== VERSION SEGURA (PreparedStatement) ===");

        List<Producto> filasSegura =
        ...
        //-----------------------------------------------------------
        // 3) Medición del listar() con System.nanoTime()
        //-----------------------------------------------------------
        ...
        //-----------------------------------------------------------
        // 4) Medición del listar() con Spring StopWatch
        //-----------------------------------------------------------
